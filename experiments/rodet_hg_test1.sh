...
python test.py rodet --dataset dota  --exp_id dota_hg_drn_s1_retrain_01_1 --K 800 --debug 2 --arch hourglass --keep_res --nms --load_model ../exp/rodet/dota_hg_drn_s1_retrain_da_.01/model_140.pth --gpus 1 --number_stacks 1  --fsm --rot
