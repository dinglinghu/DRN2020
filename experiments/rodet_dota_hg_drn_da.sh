...
python3 main.py rodet --dataset dota --exp_id dota_hg_drn_da05 --K 600 --arch hourglass --batch_size 1 --master_batch 1 --lr 4e-4 --save_all --load_model ../models/ExtremeNet_500000.pth --gpus 3  --angle_weight 1  --cache_model 5 --dense_angle --fsm --rot  --drmc --e2e
## test
