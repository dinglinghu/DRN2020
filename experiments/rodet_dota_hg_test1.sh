...
python test.py rodet --dataset dota --exp_id dota_hg_drn_xv_tvaug --K 800 --arch hourglass --keep_res --nms --load_model ../exp/rodet/dota_hg_drn_xv_tvaug/model_5.pth --gpus 1 --trainval  --drmc --fsm --rot
## test
