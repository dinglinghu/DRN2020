cd src
exp_id_0=dota_drn_tv2_$1
exp_id_1=dota_drn_tv2_$2
...
python test.py rodet --dataset dota  --exp_id ${exp_id_0} --debug 2 --trainval --K 800 --arch hourglass --keep_res --nms --load_model ../exp/rodet/${exp_dir_0}/${model_0} --gpus 2 --test_split 2  --fsm --rot --drmc --number_stacks 1 #--test_scales 0.5,0.75,1.0,1.25,1.5,2.0
if [ -n "$2" ]
then
python test.py rodet --dataset dota  --exp_id ${exp_id_1}_1 --debug 2 --trainval --K 800 --arch hourglass --keep_res --nms --load_model ../exp/rodet/${exp_dir_1}/${model_1} --gpus 2 --test_split 2 --fsm --rot --drmc  --number_stacks 1 #--test_scales 0.5,1.0,1.5
fi
