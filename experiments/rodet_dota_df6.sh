cd src
exp_id_0=dota_drn_tv6_$1
exp_id_1=dota_drn_tv6_$2
...
python test.py rodet --dataset dota  --exp_id ${exp_id_0} --debug 2 --trainval --K 800 --arch hourglass --keep_res --nms --load_model ../exp/rodet/${exp_dir}/${model_0} --gpus 3 --test_split 6 --flip_test --test_scales 0.5,0.75,1.0,1.5,2.0 #--fsm --rot --drmc
if [ -n "$2" ]
then
python test.py rodet --dataset dota  --exp_id ${exp_id_1} --debug 2 --trainval --K 800 --arch hourglass --keep_res --nms --load_model ../exp/rodet/${exp_dir}/${model_1} --gpus 3 --test_split 6 #--fsm --rot --drmc --flip_test #--test_scales 0.5,0.75,1.0,1.25,1.5,2.0
fi
